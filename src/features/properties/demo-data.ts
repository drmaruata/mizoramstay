...
export const properties: Property[] = [
  {
    ...
    amenities: ['Wi-Fi', 'Breakfast', 'Parking', 'Hot water'], verificationLevel: 4, tourismRegistered: true, cancellation: 'Free cancellation up to 48 hours before check-in', hostName: 'Lalhmingmawia', latitude: 23.7271, longitude: 92.7176, media: [],
    rooms: [
      { id: 'room-101', name: 'Deluxe Double Room', maxGuests: 2, beds: '1 queen bed', bathroom: 'Attached bathroom', price: 1800, description: 'Bright room with a queen bed and attached bathroom.', roomType: 'Double', images: [] },
      { id: 'room-102', name: 'Family Room', maxGuests: 4, beds: '2 queen beds', bathroom: 'Attached bathroom', price: 2600, description: 'A larger room for families or small groups.', roomType: 'Family', images: [] },
    ]
  },
  {
    ...
    amenities: ['Mountain view', 'Breakfast', 'Garden', 'Parking'], verificationLevel: 5, tourismRegistered: true, cancellation: 'Free cancellation up to 5 days before check-in', hostName: 'Malsawmdawngliana', latitude: 23.6833, longitude: 92.6167, media: [],
    rooms: [{ id: 'room-201', name: 'Valley View Room', maxGuests: 2, beds: '1 king bed', bathroom: 'Attached bathroom', price: 2200, description: 'A quiet room with a king bed and valley outlook.', roomType: 'King', images: [] }]
  },
  {
    ...
    amenities: ['Wi-Fi', 'Local food', 'Parking', 'Hot water'], verificationLevel: 3, tourismRegistered: true, cancellation: 'Free cancellation up to 72 hours before check-in', hostName: 'Rinawma Sailo', latitude: 23.4561, longitude: 93.3287, media: [],
    rooms: [{ id: 'room-301', name: 'Local Comfort Room', maxGuests: 2, beds: '1 double bed', bathroom: 'Shared bathroom', price: 1600, description: 'A practical room for travellers exploring Champhai.', roomType: 'Double', images: [] }]
  },
  {
    ...
    amenities: ['Wi-Fi', 'Breakfast', 'Generator', 'Family room'], verificationLevel: 4, tourismRegistered: true, cancellation: 'Free cancellation up to 48 hours before check-in', hostName: 'Vanlalruata', latitude: 23.3, longitude: 92.95, media: [],
    rooms: [{ id: 'room-401', name: 'Garden Room', maxGuests: 3, beds: '1 queen + 1 single', bathroom: 'Attached bathroom', price: 1950, description: 'Comfortable garden-facing room for a couple or small family.', roomType: 'Family', images: [] }]
  },
]
